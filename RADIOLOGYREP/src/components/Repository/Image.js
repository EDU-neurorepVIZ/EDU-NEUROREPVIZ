    ...
    thumbnailStyle () {
        ...
        switch (this.props.item.orientation) {
            ...
            case 8:
                ...
                break;
            case 2:
                rotationTransformValue = "rotateY(0deg)";
                break;
            case 4:
                rotationTransformValue = "rotate(180deg) rotateY(0deg)";
                break;
            case 5:
                rotationTransformValue = "rotate(270deg) rotateY(0deg)";
                break;
            case 7:
                rotationTransformValue = "rotate(90deg) rotateY(0deg)";
                break;
        }
        if (this.props.item.isSelected){
        ...
        return (
            ...
            >
                {ThumbnailImageComponent ?
                    ...
                    <a href={this.props.item.directory} target="_blank"><img {...thumbnailProps} /></a>}
                </div>
